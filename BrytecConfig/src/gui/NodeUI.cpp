...
void NodeUI::drawNode(std::shared_ptr<Node> node, NodeWindow::Mode& mode, std::weak_ptr<NodeGroup> nodeGroup, float nodeWidth)
{
    ...
    case NodeTypes::Counter: {
        UI::InputBool(node, 0, "Up");
        UI::InputBool(node, 1, "Down");
    ...
    case NodeTypes::Holley_Broadcast: {
        static const char* channels[] = {
            ...
            "TC Lauch Input",
            "DI Fuel g/cyl",
            "VVT Desiered Intake Cam Pos",
            "VVT Actual Intake Cam Pos",
            "VVT Intake Sol Duty",
            "VVT Desired Exhaust Cam Pos",
            "VVT Actual Exhaust Cam Pos",
            "VVT Exhaust Sol Duty",
            "Governor Pressure Actual",
            "Governor Pressure Target",
            "Line Pressure Actual",
            "Race Trans Lauch",
            "Spool Assist Out 2",
            "Shift Single Out",
            "Shift Output 1-2 Output",
            "Shift Output 2-3 Output",
            "Shift Output 3-4 Output",
            "Shift Output 4-5 Output",
            "Shift Output 5-6 Output",
            "Shift Output 6-7 Output",
            "Shift Output 7-8 Output",
            "Shift Over-Ride",
            "Shift Master Enable",
            "Shift Ignition Cut",
            "Shift Timing Mod",
